...
## Objective
We were tasked with designing a wind turbine blade to operate at low Reynolds numbers. Our group chose to maximize aerodynamic efficiency to optimize the power output and improve the performance from the baseline design provided in Lab 4. Our blade must also adhere to the following constraints:
